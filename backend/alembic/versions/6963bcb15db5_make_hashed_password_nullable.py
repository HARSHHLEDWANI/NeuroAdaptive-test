...
def upgrade() -> None:
    ...
    # batch_alter_table so the chain is dialect-portable: SQLite cannot
    # ALTER COLUMN and needs a table rebuild, while on PostgreSQL this emits
    # the same plain ALTER it did before. Behaviour on production is unchanged.
